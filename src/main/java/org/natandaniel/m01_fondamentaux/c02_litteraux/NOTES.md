...
`char` est un entier **non signé** de 16 bits. Il participe aux expressions arithmétiques : `'A' + 1` produit un `int` (66). Pour récupérer un `char`, cast explicite : `(char)('A' + 1)`. L'exercice exploite l'écart constant `'a' - 'A' = 32`.
